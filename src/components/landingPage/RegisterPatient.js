      ...
      <div className="bg-white w-full">
        <div className="">
          <div className=" flex justify-center mt-4">
            <h1 className="p-2 px-8 rounded font-sans font-semibold text-5xl text-slate-800">REGISTER</h1>
          </div>

          <form
            className="font-poppins lg:ml-60  lg:px-8 lg:py-4 bg-teal-50 shadow-lg rounded max-w-screen-lg mt-8 mb-4 "
          ...
          >
            <div className="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
              <button
                ...
                className={
                  Toggle === "Patient"
                    ? "py-2 px-8 text-lg font-poppins font-bold cursor-pointer rounded bg-slate-200"
                    : "py-2 px-8 text-lg font-poppins font-semibold cursor-pointer rounded bg-slate-100"
                }
              >
                Patient
              </button>
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              <div className="flex justify-center">
                <h1 className=" p-4 rounded font-bold lg:text-3xl text-3xl mt-2 font-sans text-slate-800">
              ...
              <div className="flex justify-center mb-4 mt-8">
                {Loading ? (
                  ...
                  <button className="bg-slate-200 rounded p-2 px-8 font-bold text-xl hover:bg-slate-50 mb-4 ">
                    SUBMIT
                  </button>
                )}
              </div>
